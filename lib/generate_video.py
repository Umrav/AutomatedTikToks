...
class VideoGenerator:
    ...
    def write_title_to_video(self,
        ...
        title_textclip = title_textclip.set_position(('center', 300)).set_duration(title_duration)
    ...
    def write_multi_text_to_video(self,
        ...
        '''
        # starting offset for text audio at title offset + time_offset
        current_text_offset = title_offset + time_offset
        text_clips = []
        ...
        # adding small .2 sec of video, to stop abrupt audio ending
        video = CompositeVideoClip([video, *text_clips])\
            .set_duration(min(current_text_offset, video.duration))

        return video
    
    def preview_clip(self, video, t=0):
        video.save_frame("frame.png", t=t)
    ...
    def make_filename(type: str) -> str:
        ...
        return f'finalized_{type}_{now.day}{now.month}{now.year}_{now.hour}{now.minute}.mp4'
    ...
    def generate_video_from_advice_submission(self,
        ...
        :param submission: audio enriched submission dict generated by AudioGenerator
        :param output_folder: folder to store finalized TikTok video
        :param char_count: count of words before newline is inserted (default: 6)
        :param max_vid_length: maximum video length in seconds (default: 120)
        :returns: NoReturn
        '''
        # choose random background video
