...
class AudioGenerator:
    ...
    def sanitize_sentence_for_gtts(censored_sentence: str) -> str:
        ...
        return re.sub('[\\*]{1}', '', beeped_sentence)
    ...
    def generate_audio_from_advice_submission(self,
        ...
        :return: dictionary containing the title/ postbody text and their audio recording filepaths
        '''
        audio_file_dict = {}
    ...
    def generate_audio_from_qna_submission(self,
                                           ...
                                           submission: Dict[str, Union[str, List[str]]]) -> Dict[str, Dict]:
        ...
        :param base_output_path: folder path to store generate audio.
        :param submission: reddit submission data generated by ContentGeneration
        :return: dictionary containing the title/ comment text and their audio recording filepaths
        '''
        audio_file_dict = {}
        submission_title = submission['title']
